					...
					<div class="row">
						<div class="col-xs-12">
							<div class="well text-center">
								<h2>Lucas Laudick</h2>
								<h3>Web Developer</h3>
								<p>I am an entry level Junior Web Developer with a degree in Business Administration and a certificate of completion from the Deep Dive Coding Bootcamp at the stimulus center at CNM. I am known for my attention to detail and my ability to be a hard worker and a team player.</p>
								<h3>Technical Toolbox</h3>
								<h4>Languages</h4>
								<p>HTML5, CSS3, Angular, JavaScript, PHP, Bootstrap</p>
								...
								<p>Customer service, Cash Transactions, Fast paced work environment</p>
								<p>Computer software that allows me to transfer between accounts and provide members with transaction history </p>
								<p>Knowledge about company products and ability to figure out member needs</p>
